// GENERATED from dictionary.jsx by scripts/build-jsx.mjs — do not edit; edit the .jsx and run `npm run build`.
(function () {
// dictionary.jsx
...
(function () {
  ...
  function DictionaryPanel(ctx) {
    ...
    if (loading) return /*#__PURE__*/React.createElement("div", { style: paneStyle }, /*#__PURE__*/React.createElement("div", { style: statusStyle }, "Loading dictionary\u2026"));
    if (err) return /*#__PURE__*/React.createElement("div", { style: paneStyle }, /*#__PURE__*/React.createElement("div", { style: { ...statusStyle, color: "var(--cx-warn, #ffc46b)" } }, "Couldn't load dictionary: ", err));

    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-dict-pane", style: paneStyle }, /*#__PURE__*/
      React.createElement("header", { style: headerStyle }, /*#__PURE__*/
      React.createElement("div", { style: titleRowStyle }, /*#__PURE__*/
      React.createElement("span", { style: { fontSize: 20, marginRight: 6 } }, "\u2135"), /*#__PURE__*/
      React.createElement("b", { style: { fontFamily: "var(--cx-font-serif, 'Cormorant Garamond', serif)", fontSize: 18 } }, "Bible Dictionary"

      ),
      mod && mod.meta && mod.meta._partial ? /*#__PURE__*/
      React.createElement("span", { style: partialPillStyle, title: "Sample of ~200 entries from Easton's ~4000." }, "SAMPLE \xB7 ",
      allKeys.length, " of ~4000"
      ) :
      null
      ), /*#__PURE__*/
      React.createElement("div", { style: { marginTop: 6 } }, /*#__PURE__*/
      ...
      React.createElement("div", { style: letterBarStyle },
      ...
      !currentEntry && !query.trim() && !letter && picks.length > 0 ? /*#__PURE__*/
      React.createElement("section", { style: picksStripStyle }, /*#__PURE__*/
      React.createElement("div", { style: picksHStyle }, "Dictionary picks for this chapter"), /*#__PURE__*/
      React.createElement("div", { style: picksRowStyle },
      picks.map((k) => /*#__PURE__*/
      React.createElement("button", { key: k, onClick: () => openEntry(k), style: pickCardStyle, title: `Open ${entries[k].title}` }, /*#__PURE__*/
      React.createElement("div", { style: { fontSize: 14, fontWeight: 600 } }, entries[k].title), /*#__PURE__*/
      React.createElement("div", { style: { fontSize: 10, opacity: 0.7, marginTop: 2, letterSpacing: "0.08em", color: kindColor(entries[k].kind) } },
      ...
      !currentEntry && query.trim() ? /*#__PURE__*/
      React.createElement("section", { style: { marginBottom: 10 } }, /*#__PURE__*/
      React.createElement("div", { style: sectionHStyle }, "Results"),
      searchResults.length === 0 ? /*#__PURE__*/
      React.createElement("div", { style: { ...statusStyle, paddingTop: 8 } }, "No matches for ", /*#__PURE__*/
      React.createElement("b", null, "\"", query, "\""), " in the sample.", /*#__PURE__*/
      React.createElement("div", { style: { marginTop: 8 } }, /*#__PURE__*/
      ...
      searchResults.map((k) => /*#__PURE__*/
      React.createElement("li", { key: k, style: resultRowStyle }, /*#__PURE__*/
      React.createElement("button", { style: resultBtnStyle, onClick: () => openEntry(k) }, /*#__PURE__*/
      React.createElement("b", null, entries[k].title), /*#__PURE__*/
      React.createElement("span", { style: { marginLeft: 6, fontSize: 10, opacity: 0.7, color: kindColor(entries[k].kind), letterSpacing: "0.08em" } },
      kindLabel(entries[k].kind)
      ), /*#__PURE__*/
      ...
      !currentEntry && letter ? /*#__PURE__*/
      React.createElement("section", null, /*#__PURE__*/
      React.createElement("div", { style: sectionHStyle }, letter), /*#__PURE__*/
      React.createElement("ul", { style: listStyle },
      letterEntries.map((k) => /*#__PURE__*/
      React.createElement("li", { key: k, style: resultRowStyle }, /*#__PURE__*/
      React.createElement("button", { style: resultBtnStyle, onClick: () => openEntry(k) }, /*#__PURE__*/
      React.createElement("b", null, entries[k].title), /*#__PURE__*/
      React.createElement("span", { style: { marginLeft: 6, fontSize: 10, opacity: 0.7, color: kindColor(entries[k].kind), letterSpacing: "0.08em" } },
      ...
      !currentEntry && !query.trim() && !letter && picks.length === 0 ? /*#__PURE__*/
      React.createElement("div", { style: { ...statusStyle, opacity: 0.75 } }, "Search above, tap a letter, or open a verse and use ", /*#__PURE__*/
      React.createElement("i", null, "Look up in Dictionary"), "."
      ) :
      null,


      currentEntry ? /*#__PURE__*/
      React.createElement("article", { style: entryStyle }, /*#__PURE__*/
      React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 } },
      trail.length > 1 ? /*#__PURE__*/
      React.createElement("button", { onClick: onBack, style: backBtnStyle, title: "Back to previous entry" }, "\u2190 back") :
      null, /*#__PURE__*/
      React.createElement("button", { onClick: onClearEntry, style: backBtnStyle, title: "Close entry" }, "\xD7 close")
      ), /*#__PURE__*/
      React.createElement("h2", { style: entryTitleStyle }, currentEntry.title), /*#__PURE__*/
      React.createElement("div", { style: { ...kindBadgeStyle, color: kindColor(currentEntry.kind), borderColor: kindColor(currentEntry.kind) } },
      kindLabel(currentEntry.kind)
      ), /*#__PURE__*/
      React.createElement("div", { className: "cx-dict-body", style: entryBodyStyle },
      renderBody(currentEntry.body)
      ),
      Array.isArray(currentEntry.refs) && currentEntry.refs.length ? /*#__PURE__*/
      React.createElement("div", { style: { marginTop: 12 } }, /*#__PURE__*/
      React.createElement("div", { style: sectionHStyle }, "Scripture"), /*#__PURE__*/
      React.createElement("div", { style: chipRowStyle },
      currentEntry.refs.map((r) => /*#__PURE__*/
      React.createElement("button", { key: r, style: refChipStyle, onClick: () => navigateToRef(r), title: `Open ${formatRef(r)}` },
      formatRef(r)
      )
      )
      )
      ...
      null,
      Array.isArray(currentEntry.related) && currentEntry.related.length ? /*#__PURE__*/
      React.createElement("div", { style: { marginTop: 12 } }, /*#__PURE__*/
      React.createElement("div", { style: sectionHStyle }, "Related entries"), /*#__PURE__*/
      React.createElement("div", { style: chipRowStyle },
      ...
      React.createElement("footer", { style: footStyle }, "Easton's Bible Dictionary (1893, public domain) \u2014 sample of ",
      allKeys.length, "."
      )
      ));
    ...
    return parts.map((s, i) => {
      ...
      if (m) {
        ...
        return (/*#__PURE__*/
          ...
          before, /*#__PURE__*/
          React.createElement("blockquote", { style: pullQuoteStyle }, "\"",
          quote, "\" ", /*#__PURE__*/React.createElement("span", { style: pullCiteStyle }, "\u2014 ", cite)
          ),
          after && /*#__PURE__*/React.createElement("span", null, after, " ")
          ));

      }
      return /*#__PURE__*/React.createElement("span", { key: i }, s, " ");
    });
  }
