...
},
{
  ...
  action: () => {
    ...
    if (b) b.click();else
    window.dispatchEvent(new CustomEvent("codex:open-settings", { detail: { section: "appearance" } }));
  }
}];
...
function Omnibar({ onClose, seed }) {
  ...
  return (/*#__PURE__*/
    ...
    !q.trim() && items[0] && items[0].guide ? /*#__PURE__*/
    React.createElement(React.Fragment, null,
    firstRun ? /*#__PURE__*/
    React.createElement("div", { className: "cx-omni-firstline" }, "type anything \u2014 a verse, a question, a word") :
    null, /*#__PURE__*/
    React.createElement("div", { className: "cx-omni-guide-cap", "aria-hidden": "true" }, "try one \u2014 every row really runs")
    ) :
    null, /*#__PURE__*/
