// GENERATED from marks-plugin.jsx by scripts/build-jsx.mjs — do not edit; edit the .jsx and run `npm run build`.
(function () {
...
function MarksX() {
  ...
  const renderRow = (r) => /*#__PURE__*/
  React.createElement("div", { key: r.key, className: "cxm-row", role: "listitem" }, /*#__PURE__*/
  React.createElement("span", { className: "cxm-bar", style: { background: MARKS_HUES[r.color] || MARKS_HUES.amber }, "aria-hidden": true }), /*#__PURE__*/
  React.createElement("button", { className: "cxm-go", onClick: () => jump(r), title: `Read ${r.label}` }, /*#__PURE__*/
  React.createElement("b", null, r.label),
  r.note ? /*#__PURE__*/React.createElement("span", null, r.note) : null
  ), /*#__PURE__*/
  React.createElement("span", { className: "cxm-age" }, marksAgo(r.ts)), /*#__PURE__*/
  React.createElement("button", { className: `cxm-pin ${r.pinned ? "is-on" : ""}`, onClick: () => togglePin(r),
    "aria-pressed": r.pinned, title: r.pinned ? "Unpin" : "Pin to the top" }, "\u2316"), /*#__PURE__*/
  React.createElement("button", { className: "cxm-x", onClick: () => forget(r), "aria-label": `Forget ${r.label}`, title: "Forget this mark" }, "\xD7")
  );


  return (/*#__PURE__*/
    React.createElement("div", { className: "cxm" }, /*#__PURE__*/
    React.createElement("div", { className: "cxm-head" }, /*#__PURE__*/
    ...
    React.createElement("button", {
      ...
      onClick: () => {
        ...
        next[key] = { color: window.CODEX_DATA?.tweaks?.highlightColor || "amber", ts: Date.now(), note: "" };
        setMap(next);marksSave(next);
      } },
    "\u2726 MARK ", window.CODEX_NOW && window.CODEX_NOW.ref ? window.CODEX_NOW.ref : "HERE")
    ), /*#__PURE__*/
    React.createElement("div", { className: "cxm-scroll", role: "list", "aria-label": "Your marks" },
    pinnedRows.length ? /*#__PURE__*/React.createElement("h3", { className: "cxm-h" }, "\u2316 PINNED") : null,
    pinnedRows.map(renderRow),
    pinnedRows.length && restRows.length ? /*#__PURE__*/React.createElement("h3", { className: "cxm-h" }, "EVERYTHING") : null,
    restRows.map(renderRow),
    !rows.length ? /*#__PURE__*/
    React.createElement("div", { className: "cxm-empty" }, /*#__PURE__*/
    React.createElement("span", { "aria-hidden": true }, "\u2726"), /*#__PURE__*/
    React.createElement("p", null, "No marks yet. Tap a verse number in the reader, or \u2726 MARK above \u2014 your trail through the text starts here.")
    ) :
    null
    )
    ));
