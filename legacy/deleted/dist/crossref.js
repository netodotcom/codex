...
(function () {
  ...
  function XrefGraph({ nodes, centerKey, centerLabel, centerColor, probeRef,
    ...
    const handleClick = (e) => {
      ...
      if (!h) return;
      if (isDbl) {
        if (h.node) cbRef.current.onReaderJump(h.node.key);else
        cbRef.current.onCenterTap();
        return;
      }
      clickT.current = setTimeout(() => {
        clickT.current = 0;
        if (h.center) cbRef.current.onCenterTap();else
        cbRef.current.onRecenter(h.node.key);
      }, 280);
    };

    return (/*#__PURE__*/
      React.createElement("div", { ref: wrapRef, className: "cx-xrefg-stage" }, /*#__PURE__*/
  ...
  function CrossRefPanel({ book, bookId, chapter, verse, translation }) {
    ...
    const recenter = useCallback((key) => {
      ...
      if (hops >= 3) emitDepth("crossref-chain", k, 5);else
      emitDepth("crossref-follow", k, 1);
      pushChain(k);
    }, [pushChain]);
    ...
    const openInReader = useCallback((key) => {
      ...
      if (!p) return;
      try {
        if (typeof window.codexGoto === "function") window.codexGoto(p.bookId, p.chapter, p.verse || 1);else
        if (typeof window.codexJumpToRef === "function") window.codexJumpToRef(formatRef(key));
      } catch (e) {}
    }, []);
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-xrefg" }, /*#__PURE__*/
      React.createElement("header", { className: "cx-xrefg-head" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-xrefg-counts" },
      ...
      React.createElement("nav", { className: "cx-xrefg-trail", "aria-label": "Walked cross-reference trail" },
      chain.length > 0 ? /*#__PURE__*/
      ...
      "\u2190 back") :
      null,
      crumbs.map((k, i) => /*#__PURE__*/
      React.createElement("span", { key: i, style: { display: "inline-flex", alignItems: "center", gap: 4 } },
      i > 0 ? /*#__PURE__*/React.createElement("span", { className: "cx-xrefg-crumb-sep" }, "\u2192") : null, /*#__PURE__*/
      React.createElement("button", {
      ...
      textOpen ? /*#__PURE__*/
      React.createElement("div", { className: "cx-xrefg-text" },
      !verseText || verseText.state === "loading" ? /*#__PURE__*/
      React.createElement("span", { style: { opacity: 0.55 } }, "summoning\u2026") :
      verseText.text ? /*#__PURE__*/
      React.createElement("p", { style: { margin: 0 } }, /*#__PURE__*/
      React.createElement("sup", null, (parseVerseKey(verseText.key) || {}).verse || 1),
      verseText.text
      ) : /*#__PURE__*/

      React.createElement("span", { style: { opacity: 0.55 } }, "Text unavailable offline for ", formatRef(currentKey), ".")

      ) :
      null, /*#__PURE__*/


      React.createElement("div", { className: "cx-xrefg-readout" },
      focusNode ? /*#__PURE__*/
      React.createElement("div", null, /*#__PURE__*/
      React.createElement("div", { className: "cx-xrefg-ro-line" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-xrefg-ro-ref", style: { color: focusNode.color } },
      formatRef(focusNode.key)
      ),
      focusNode.theme ? /*#__PURE__*/
      React.createElement("span", { className: "cx-xrefg-ro-theme", style: { color: focusNode.color } },
      focusNode.theme
      ) :
      null, /*#__PURE__*/
      React.createElement("button", {
      ...
      expandedCompareKey === focusNode.key ? "× close" : "▦ compare"), /*#__PURE__*/
      React.createElement("button", {
        className: "cx-xrefg-chip",
      ...
      focusNode.note ? /*#__PURE__*/React.createElement("div", { className: "cx-xrefg-ro-snip" }, focusNode.note) : null,
      focusSnip ? /*#__PURE__*/
      React.createElement("div", { className: "cx-xrefg-ro-snip" },
      focusSnip.length > 180 ? focusSnip.slice(0, 177) + "…" : focusSnip
      ) :
      null,
      expandedCompareKey === focusNode.key ? /*#__PURE__*/
      ...
      React.createElement("div", { style: compareTextStyle },
      snippetFor(currentKey, translation) || /*#__PURE__*/React.createElement("span", { style: { opacity: 0.55 } }, "Text not cached.")
      )
      ), /*#__PURE__*/
      React.createElement("div", { style: compareColStyle }, /*#__PURE__*/
      React.createElement("div", { style: compareHeadStyle }, formatRef(focusNode.key)), /*#__PURE__*/
      React.createElement("div", { style: compareTextStyle },
      focusSnip || /*#__PURE__*/React.createElement("span", { style: { opacity: 0.55 } }, "Text not cached.")
      )
      )
      ),
      ...
      nodes.length ? /*#__PURE__*/
      React.createElement("div", { className: "cx-xrefg-hint" }, "hover a thread \xB7 click re-centers \xB7 double-click opens the reader \xB7 tap the center for text"
      ...
      nodes.map((nd) => /*#__PURE__*/
      React.createElement("li", { key: nd.key, role: "listitem" }, /*#__PURE__*/
      React.createElement("button", {
        className: "cx-xrefg-chip",
      ...
      React.createElement("footer", { className: "cx-xrefg-foot" }, /*#__PURE__*/
      React.createElement("span", null, "R. A. Torrey, Treasury of Scripture Knowledge \xB7 public domain",

      mod && mod.meta && mod.meta.totalRefs ?
      ` · ${Number(mod.meta.totalRefs).toLocaleString()} refs corpus-wide` :
      ""
      ), /*#__PURE__*/
      React.createElement("span", null, "OT ", /*#__PURE__*/React.createElement("span", { style: { color: OT_C } }, "\u25CF"), " \xB7 NT ", /*#__PURE__*/React.createElement("span", { style: { color: NT_C } }, "\u25CF"), " \xB7 seam ", /*#__PURE__*/React.createElement("span", { style: { color: SEAM_C } }, "\u2014"))
      )
      ));
