// GENERATED from continuity.jsx by scripts/build-jsx.mjs — do not edit; edit the .jsx and run `npm run build`.
(function () {
...
(function () {
  ...
  function ContinuityIndicator(props) {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: cls, role: "status", "aria-live": "polite" }, /*#__PURE__*/
      React.createElement("div", {
        ...
        style: { "--cx-ring-pct": ringPct } }, /*#__PURE__*/

      React.createElement("span", { className: "cx-continuity-count" }, status.current || 0)
      ),
      !compact && /*#__PURE__*/
      React.createElement("div", { className: "cx-continuity-meta" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-continuity-status" }, status.statusText || t("cx.continuity.active", "Continuity active")), /*#__PURE__*/
  ...
  function MasteryGrid() {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-mastery-grid" },
      domains().map(function (d) {
        ...
        return (/*#__PURE__*/
          React.createElement("div", { className: "cx-mastery-domain", key: d }, /*#__PURE__*/
          React.createElement("div", { className: "cx-mastery-domain-head" }, /*#__PURE__*/
          React.createElement("span", { className: "cx-mastery-domain-name" }, domainLabel), /*#__PURE__*/
          React.createElement("span", { className: "cx-mastery-level" }, levelLabel)
          ), /*#__PURE__*/
          React.createElement("div", {
            ...
            "data-static": reducedMotion() ? "1" : undefined,
            style: { "--cx-bar-pct": pct } }, /*#__PURE__*/

          React.createElement("span", { className: "cx-mastery-bar-ascii", "aria-hidden": "true" }, bar), /*#__PURE__*/
          React.createElement("span", { className: "cx-mastery-bar-pct", "aria-hidden": "true" }, pct, "%")
          ), /*#__PURE__*/
          React.createElement("div", { className: "cx-mastery-threads" },
  ...
  function IntelLog() {
    ...
    if (!rows.length) {
      return /*#__PURE__*/React.createElement("div", { className: "cx-dossier-stat cx-dossier-empty" }, t("cx.dossier.empty", "No threads opened yet. Begin any depth surface to open a case."));
    }

    return (/*#__PURE__*/
      React.createElement("ul", { className: "cx-intel-log", "aria-label": t("cx.dossier.intel", "Intel") },
      rows.map(function (r, i) {
        ...
        return (/*#__PURE__*/
          React.createElement("li", { className: "cx-intel-badge", key: r.id + ":" + i }, /*#__PURE__*/
          React.createElement("span", { className: "cx-intel-badge-stamp" }, isoStamp(r.stamp)), /*#__PURE__*/
          React.createElement("span", { className: "cx-intel-badge-label" }, label), /*#__PURE__*/
          React.createElement("span", { className: "cx-intel-badge-ref" }, r.id)
          ));
  ...
  function QuestPlayer(props) {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-quest-card cx-quest-active" + (done ? " cx-quest-complete" : ""), role: "group", "aria-label": quest.meta && quest.meta.title }, /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-card-head" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-quest-card-title" }, quest.meta && quest.meta.title),
      onClose && /*#__PURE__*/
      React.createElement("button", { type: "button", className: "cx-quest-close", onClick: onClose, "aria-label": "Close quest" }, "\u2715")

      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-quest-progress", "aria-label": Math.min(st.step || 0, steps.length) + " / " + steps.length },
      steps.map(function (s, i) {
        const cls = "cx-quest-progress-pip" + (
        i < (st.step || 0) ? " is-done" : "") + (
        i === stepIdx && !done ? " is-current" : "");
        return /*#__PURE__*/React.createElement("span", { key: i, className: cls, "aria-hidden": "true" }, i < (st.step || 0) ? "▰" : "▱");
      })
      ),

      !done && st.status !== "active" && /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-step" }, /*#__PURE__*/
      React.createElement("p", { className: "cx-quest-step-prompt" }, steps[0] && steps[0].prompt), /*#__PURE__*/
      React.createElement("button", { type: "button", className: "cx-quest-btn", onClick: start }, t("cx.quest.start", "Open thread"))
      ),


      !done && st.status === "active" && cur && /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-step", ref: liveRef, "aria-live": "polite" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-step-kind" }, kindLabel(cur.kind)),
      Array.isArray(cur.refs) && cur.refs.length > 0 && /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-step-refs" },
      cur.refs.map(function (rf, i) {
        return (/*#__PURE__*/
          React.createElement("a", { key: i, className: "cx-quest-ref", href: "#",
      ...
      React.createElement("p", { className: "cx-quest-step-prompt" }, cur.prompt),

      isReflect && /*#__PURE__*/
      React.createElement("div", { className: "cx-quest-reflect" }, /*#__PURE__*/
      React.createElement("label", { className: "cx-quest-reflect-label", htmlFor: "cx-quest-reflect-ta" }, t("cx.quest.step.reflect", "Reflect")), /*#__PURE__*/
      ...
      cur.reveal && /*#__PURE__*/
      React.createElement("details", { className: "cx-quest-reveal" }, /*#__PURE__*/
      React.createElement("summary", null, t("cx.quest.reveal", "Reveal")), /*#__PURE__*/
      React.createElement("p", null, cur.reveal)
      ), /*#__PURE__*/
      ...
      React.createElement("div", { className: "cx-quest-step cx-quest-done" }, /*#__PURE__*/
      React.createElement("p", { className: "cx-quest-step-prompt" }, t("cx.quest.complete", "Closed")), /*#__PURE__*/


      React.createElement("div", { className: "cx-quest-feedback" },
      !feedback && !fbLoading && /*#__PURE__*/
      React.createElement("button", { type: "button", className: "cx-quest-btn cx-quest-btn-ghost", onClick: requestFeedback },
      t("cx.milestone.unlocked", "AI analyst feedback")
      ),

      fbLoading && /*#__PURE__*/React.createElement("p", { className: "cx-quest-feedback-loading" }, "\u2026"),
      feedback && /*#__PURE__*/
      React.createElement("blockquote", { className: "cx-quest-feedback-text", "data-ai": "1" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-quest-feedback-flag", "aria-hidden": "true" }, "AI"),
      feedback
      ),

      fbError && /*#__PURE__*/React.createElement("p", { className: "cx-quest-feedback-err" }, fbError || "—")
      ), /*#__PURE__*/

      React.createElement("button", { type: "button", className: "cx-quest-btn", onClick: exportStudy }, "\u2913 .codex-study"
  ...
  function QuestList() {
    ...
    if (openId) {
      return /*#__PURE__*/React.createElement(QuestPlayer, { questId: openId, onClose: function () {setOpenId(null);load();} });
    }

    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-quest-list", "aria-label": t("cx.quest.title", "Quests") },
      !quests.length && /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-stat cx-dossier-empty" }, t("cx.dossier.empty", "No threads opened yet. Begin any depth surface to open a case.")),
      ...
      quests.map(function (q) {
        ...
        return (/*#__PURE__*/
          React.createElement("button", {
            ...
            key: q.id,
            className: cls,
            onClick: function () {setOpenId(q.id);} }, /*#__PURE__*/

          React.createElement("span", { className: "cx-quest-card-title" }, q.title), /*#__PURE__*/
          React.createElement("span", { className: "cx-quest-card-meta" },
          q.domain ? t("cx.domain." + q.domain, q.domain) : "",
          q.tradition ? " · " + q.tradition : ""
          ), /*#__PURE__*/
          React.createElement("span", { className: "cx-quest-card-status" },
  ...
  function AnalystDossier(ctx) {
    ...
    if (!ENG()) {
      return /*#__PURE__*/React.createElement("div", { className: "cx-dossier" }, /*#__PURE__*/React.createElement("div", { className: "cx-dossier-stat cx-dossier-empty" }, t("cx.dossier.empty", "No threads opened yet. Begin any depth surface to open a case.")));
    }
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-dossier" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-header" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-title" }, t("cx.dossier.title", "Analyst desk"))
      ), /*#__PURE__*/

      React.createElement(IntelBanner, { console: "CONTINUITY", scope: "READER DOSSIER", note: "YOUR OWN RECORD \xB7 STORED LOCALLY \xB7 NEVER UPLOADED" }), /*#__PURE__*/

      React.createElement("div", { className: "cx-dossier-section cx-dossier-section--continuity" }, /*#__PURE__*/
      React.createElement(ContinuityIndicator, null)
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-dossier-section cx-dossier-section--intel" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-stat" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-k" }, t("cx.continuity.title", "Continuity")), /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-v" }, cont.current || 0, " \xB7 \u21A5 ", cont.longest || 0)
      ), /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-stat" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-k" }, t("cx.domain.canon-coverage", "Canon coverage")), /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-v" }, t("cx.mastery.threads", "{n} threads closed", { n: canon.threads || 0 }))
      ), /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-stat" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-k" }, "\u21BB"), /*#__PURE__*/
      React.createElement("span", { className: "cx-dossier-stat-v" }, topDomain ? t("cx.domain." + topDomain, topDomain) + " · " + topThreads : "—")
      )
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-dossier-section cx-dossier-section--mastery" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-subhead" }, t("cx.mastery.title", "Mastery")), /*#__PURE__*/
      React.createElement(MasteryGrid, null)
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-dossier-section cx-dossier-section--quests" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-subhead" }, t("cx.quest.title", "Quests")), /*#__PURE__*/
      React.createElement(QuestList, null)
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-dossier-section cx-dossier-section--log" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-dossier-subhead" }, t("cx.dossier.intel", "Intel")), /*#__PURE__*/
      React.createElement(IntelLog, null)
      )
      ));
  ...
  function NextThread() {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-nextthread", title: t("cx.nextthread.title", "Next thread") }, /*#__PURE__*/
      React.createElement("button", { type: "button", className: "cx-nextthread-btn", onClick: act }, /*#__PURE__*/
      React.createElement("span", { className: "cx-nextthread-glyph", "aria-hidden": "true" }, "\u2301"), /*#__PURE__*/
      React.createElement("span", { className: "cx-nextthread-label" }, label),
      sugg.reason ? /*#__PURE__*/React.createElement("span", { className: "cx-nextthread-reason" }, sugg.reason) : null
      ), /*#__PURE__*/
      React.createElement("button", {
        type: "button",
  ...
  function ContinuityMount() {
    ...
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-continuity-mount" }, /*#__PURE__*/
      React.createElement(NextThread, null)
      ));
