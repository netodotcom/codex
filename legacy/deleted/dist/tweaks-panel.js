...
function TweakRadio({ label, value, options, onChange }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { ref: trackRef, role: "radiogroup", "aria-label": label, onPointerDown: onPointerDown,
...
function TweakSelect({ label, value, options, onChange }) {
  return (/*#__PURE__*/
    React.createElement(TweakRow, { label: label }, /*#__PURE__*/
    React.createElement("select", { className: "twk-field", value: value, "aria-label": label,
...
function TweakNumber({ label, value, min, max, step = 1, unit = '', onChange }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("input", { type: "number", value: value, min: min, max: max, step: step, "aria-label": label,
...
function TweakColor({ label, value, options, onChange }) {
  if (!options || !options.length) {
    return (/*#__PURE__*/
      ...
      React.createElement("div", { className: "twk-lbl" }, /*#__PURE__*/React.createElement("span", null, label)), /*#__PURE__*/
      React.createElement("input", { type: "color", className: "twk-swatch", value: value, "aria-label": label,
        onChange: (e) => onChange(e.target.value) })
      ));
  ...
  return (/*#__PURE__*/
    React.createElement(TweakRow, { label: label }, /*#__PURE__*/
    React.createElement("div", { className: "twk-chips", role: "radiogroup", "aria-label": label },
    options.map((o, i) => {
...
function TweakPersonalization() {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("p", { className: "twkx-hint" }, "CODEX learns from your likes, Oracle questions, and highlights to tailor Reels."

    ), /*#__PURE__*/
    React.createElement(TweakButton, { label: "Clear profile & Oracle context", secondary: true, onClick: onClear }),
    done && /*#__PURE__*/React.createElement("span", { className: "twk-val" }, "Personalization cleared")
    ));
...
function AIModelSection({ provider, model, availableProviders, onChange }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { className: "cx-tp-key-row twkx-keyrow" }, /*#__PURE__*/
    ...
    React.createElement("button", { type: "button", className: "twkx-eye", onClick: () => setShowKey((s) => !s),
      "aria-label": showKey ? 'Hide key' : 'Reveal key',
      title: showKey ? 'Hide key' : 'Reveal key' }, showKey ? '◐' : '◌'), /*#__PURE__*/
    React.createElement("button", {
...
function TwkItem({ kw, passive, children }) {
  return (/*#__PURE__*/
    React.createElement("div", { className: "twkx-item", "data-kw": kw || '', "data-passive": passive ? '1' : '0' },
    children
    ));
...
function AutoTweakRow({ entry }) {
  ...
  if (typeof v === 'boolean') {
    return /*#__PURE__*/React.createElement(TweakToggle, { label: entry.label, value: v, onChange: write });
  }
  if (typeof v === 'number') {
    return /*#__PURE__*/React.createElement(TweakNumber, { label: entry.label, value: v, onChange: (n) => write(n) });
  }
  if (typeof v === 'string') {
    return /*#__PURE__*/React.createElement(TweakText, { label: entry.label, value: v, onChange: write });
  }
  return (/*#__PURE__*/
    React.createElement(TweakRow, { label: entry.label, value: String(v) }, /*#__PURE__*/
    React.createElement("p", { className: "twkx-hint" }, "registered tweak \xB7 no editor for this shape yet")
    ));
...
function SelfControls({ group, t, setTweak }) {
  ...
  const setTheme = (v) => {
    if (v === 'auto') setTweak({ autoTheme: true });else
    setTweak({ autoTheme: false, manualDark: v === 'night' });
  };
  const translations = window.CODEX_DATA && window.CODEX_DATA.translations || [];

  if (group === 'APPEARANCE') {
    return (/*#__PURE__*/
      React.createElement(TwkItem, { kw: "theme dark light night day auto solar lights appearance mode" }, /*#__PURE__*/
      React.createElement(TweakRadio, { label: "Theme", value: themeVal,
        options: [
        { value: 'auto', label: '☉ AUTO' },
        { value: 'day', label: 'DAY' },
        { value: 'night', label: 'NIGHT' }],

        onChange: setTheme }), /*#__PURE__*/
      React.createElement("p", { className: "twkx-hint" }, "Auto follows the sun at your hour \u2014 day pages, night glass.")
      ));
  ...
  if (group === 'SCRIPTURE') {
    return (/*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement(TwkItem, { kw: "font size text scale scripture aa bigger smaller reader type" }, /*#__PURE__*/
      React.createElement(TweakSlider, { label: "Scripture size", value: Number(t.fontScale) || 22,
        min: 16, max: 30, step: 1, unit: "px",
        onChange: (v) => {setTweak('fontScale', v);__cxApplyFontPreview(v);} }), /*#__PURE__*/
      React.createElement("p", { className: "twkx-hint" }, "Live \u2014 the reader behind repaints as you slide.")
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "font face serif mono typeface family scripture" }, /*#__PURE__*/
      React.createElement(TweakRadio, { label: "Scripture face", value: t.scriptureFont || 'serif',
      ...
      translations.length > 0 && /*#__PURE__*/
      React.createElement(TwkItem, { kw: "translation bible version primary kjv web text" }, /*#__PURE__*/
      React.createElement(TweakSelect, { label: "Primary translation", value: t.primaryTranslation || 'kjv',
      ...
      React.createElement(TwkItem, { kw: "red letter words of jesus christ crimson" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Red-letter words of Jesus", value: t.redLetter !== false,
        onChange: (v) => setTweak('redLetter', v) })
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "side by side parallel two translations columns compare" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Side-by-side translations", value: !!t.sideBySide,
  ...
  if (group === 'THE NAME') {
    return (/*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement(TwkItem, { kw: "divine gold golden name covenant color reader yhwh tetragrammaton yahweh jehovah lord restore sacred" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "The Name in covenant gold", value: t.divineGold !== false,
        onChange: (v) => setTweak('divineGold', v) })
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "divine hebrew tetragrammaton script reader yhwh" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Tetragrammaton in Hebrew (\u05D9\u05D4\u05D5\u05D4)", value: !!t.divineHebrew,
        onChange: (v) => setTweak('divineHebrew', v) }), /*#__PURE__*/
      React.createElement("p", { className: "twkx-hint" }, "The reader renders the Name in its own script where the Hebrew carries it.")
      )
      ));
  ...
  if (group === 'READING') {
    return (/*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement(TwkItem, { kw: "distraction free focus zen hide chrome quiet theater" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Distraction-free reading", value: !!t.distractionFree,
        onChange: (v) => setTweak('distractionFree', v) }), /*#__PURE__*/
      React.createElement("p", { className: "twkx-hint" }, "Only the Word on screen. Also: the \u229F button in the footer, or F to focus.")
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "overlay gnosis reader margin esoteric glyph" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Reader overlay \xB7 Gnosis", value: !!t.overlayGnosis,
        onChange: (v) => setTweak('overlayGnosis', v) })
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "overlay talmud reader margin rabbinic glyph" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Reader overlay \xB7 Talmud", value: !!t.overlayTalmud,
        onChange: (v) => setTweak('overlayTalmud', v) })
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "overlay commentary reader margin voices glyph" }, /*#__PURE__*/
      React.createElement(TweakToggle, { label: "Reader overlay \xB7 Commentary", value: !!t.overlayCommentary,
        onChange: (v) => setTweak('overlayCommentary', v) }), /*#__PURE__*/
      React.createElement("p", { className: "twkx-hint" }, "Overlays paint quiet glyphs in the reader's margin \u2014 also togglable from the reader itself.")
      )
      ));
  ...
  if (group === 'INSTRUMENTS') {
    return (/*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement(TwkItem, { kw: "continuity streak engagement mastery analyst depth announcements cadence" }, /*#__PURE__*/
      React.createElement(TweakContinuity, null)
      ), /*#__PURE__*/
      React.createElement(TwkItem, { kw: "gnosis overlay esoteric ring engaged dormant", passive: true }, /*#__PURE__*/
      React.createElement("div", { className: "twkx-note" }, "\u27C1 ", /*#__PURE__*/
      React.createElement("b", null, "Gnosis overlay"), " \u2014 lives on the master ring in the desk footer (DORMANT / ENGAGED). One tap there; it never hides in a menu."
  ...
  if (group === 'SYSTEM') {
    return (/*#__PURE__*/
      React.createElement(TwkItem, { kw: "tour welcome replay onboarding first run" }, /*#__PURE__*/
      React.createElement(TweakButton, { label: "\u21BB Replay the welcome tour", secondary: true,
        onClick: () => {
  ...
  if (group === 'DANGER') {
    return (/*#__PURE__*/
      React.createElement(TwkItem, { kw: "personalization profile taste reels oracle context clear privacy" }, /*#__PURE__*/
      React.createElement(TweakPersonalization, null)
      ));
...
function TweaksPanel({ title = 'Settings', noDeckControls = false, children }) {
  ...
  React.useEffect(() => {
    const onMsg = (e) => {
      ...
      if (ty === '__activate_edit_mode') setOpen(true);else
      if (ty === '__deactivate_edit_mode') setOpen(false);
    };
  ...
  React.useEffect(() => {
    ...
    const onOpen = (e) => {
      ...
      setMode('settings');
      if (/api|ai|model|engine|infer|key/.test(sect)) scrollToGroup('AI & KEYS');else
      if (/name|yhwh/.test(sect)) scrollToGroup('THE NAME');else
      if (/scripture|font|translat/.test(sect)) scrollToGroup('SCRIPTURE');else
      if (/look|theme|appear/.test(sect)) scrollToGroup('APPEARANCE');else
      if (/read|mark|note/.test(sect)) scrollToGroup('READING');else
      if (/sync|cache|offline|data|export|import|install|lang|system/.test(sect)) scrollToGroup('SYSTEM');
    };
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { className: "twkx-scrim", "data-noncommentable": "", onMouseDown: dismiss }), /*#__PURE__*/
    React.createElement("div", { ref: panelRef, className: "twkx-panel", "data-noncommentable": "",
      role: "dialog", "aria-modal": "true", "aria-label": title }, /*#__PURE__*/
    React.createElement("div", { className: "twkx-head" }, /*#__PURE__*/
    React.createElement("span", { className: "twkx-title" }, title), /*#__PURE__*/
    React.createElement("div", { className: "twkx-mode", role: "tablist", "aria-label": "Settings or help" }, /*#__PURE__*/
    React.createElement("button", { role: "tab", "aria-selected": mode === 'settings', onClick: () => switchMode('settings') }, "SETTINGS"), /*#__PURE__*/
    React.createElement("button", { role: "tab", "aria-selected": mode === 'help', onClick: () => switchMode('help') }, "HELP")
    ), /*#__PURE__*/
    React.createElement("span", { className: "twkx-spacer" }), /*#__PURE__*/
    React.createElement("button", { className: "twkx-x", "aria-label": "Close settings", onClick: dismiss }, "\u2715")
    ),

    mode === 'help' ? /*#__PURE__*/
    React.createElement("div", { className: "twkx-help-body" },
    HelpWiki ? /*#__PURE__*/React.createElement(HelpWiki, null) : /*#__PURE__*/
    React.createElement("div", { className: "twkx-empty" }, "Help wiki loading\u2026")

    ) : /*#__PURE__*/

    React.createElement("div", { className: "twkx-shell" }, /*#__PURE__*/
    React.createElement("nav", { className: "twkx-nav", "aria-label": "Setting groups" },
    SETTINGS_GROUPS.map((g) => /*#__PURE__*/
    React.createElement("button", { key: g,
    ...
    React.createElement("div", { className: "twkx-main" }, /*#__PURE__*/
    React.createElement("div", { className: "twkx-search" }, /*#__PURE__*/
    React.createElement("input", {
      ref: searchRef,
      type: "text",
      value: query,
    ...
    React.createElement("span", { className: "twkx-count", "aria-live": "polite" },
    matchCount == null ? '' : matchCount === 0 ? 'no matches' : `${matchCount} match${matchCount === 1 ? '' : 'es'}`
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "twkx-body", ref: bodyRef, role: "region", "aria-label": "Settings" },
    SETTINGS_GROUPS.map((g) => /*#__PURE__*/
    React.createElement("section", { key: g, className: "twkx-group", "data-group": g }, /*#__PURE__*/
    React.createElement("h2", { className: "twkx-group-h" }, g), /*#__PURE__*/
    React.createElement(SelfControls, { group: g, t: t, setTweak: setTweak }),
    (clustersByGroup[g] || []).map((c, ci) => /*#__PURE__*/
    React.createElement(React.Fragment, { key: `${g}-${ci}` },
    c.label ? /*#__PURE__*/React.createElement("div", { className: "twkx-sub" }, c.label) : null,
    c.items.map((node, ni) => /*#__PURE__*/
    React.createElement(TwkItem, { key: ni, kw: `${c.label} ${c.kw}`, passive: isPassiveNode(node) },
    node
    )
    )
    )
    ),
    (unknownByGroup[g] || []).map((u) => /*#__PURE__*/
    React.createElement(TwkItem, { key: u.key, kw: `${u.kw} ${u.key} tweak` }, /*#__PURE__*/
    React.createElement(AutoTweakRow, { entry: u })
    )
    )
    )
    ),
    matchCount === 0 && /*#__PURE__*/
    React.createElement("div", { className: "twkx-empty" }, "nothing matches \u201C", query, "\u201D \u2014 try \u2018theme\u2019, \u2018font\u2019, \u2018key\u2019, \u2018offline\u2019\u2026")
