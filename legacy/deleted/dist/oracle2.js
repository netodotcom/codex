...
function oracle2ToolDirective() {
  ...
  try {
    ...
    if (K && typeof K.toolSpecs === "function") specs = K.toolSpecs();else
    if (K && typeof K.tools === "function") specs = K.tools().map((n) => ({ name: n, description: "" }));
  } catch {}
...
function OracleX() {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { className: "cxo2-tabs", role: "tablist", "aria-label": "Oracle threads" },
    threads.map((t) => {
      const isActive = active && t.id === active.id;
      return (/*#__PURE__*/
        React.createElement("button", { key: t.id, role: "tab", "aria-selected": isActive,
          className: `cxo2-tab ${isActive ? "is-active" : ""}`,
          onClick: () => {setActiveId(t.id);setErr(null);},
          title: t.title }, /*#__PURE__*/
        React.createElement("span", { className: "cxo2-tab-lbl" }, t.title),
        threads.length > 1 ? /*#__PURE__*/
        React.createElement("span", { className: "cxo2-tab-x", role: "button", tabIndex: -1, "aria-label": "Close thread",
          onClick: (e) => {e.stopPropagation();closeThread(t.id);} }, "\xD7") :
        null
        ));

    }), /*#__PURE__*/
    React.createElement("button", { className: "cxo2-tab-new", onClick: newThread, title: "New thread", "aria-label": "New thread" }, "+"),
    window.CODEX_KERNEL ? /*#__PURE__*/
    React.createElement("button", { className: `cxo2-tools ${toolsOn ? "is-on" : ""}`,
      ...
      "Agent tools OFF — prose-only replies. Click to enable." }, "\u2692 TOOLS"
    ...
    React.createElement("button", { className: "cxo-clear", onClick: () => patchActive([]), title: "Burn this thread's messages" }, "CLEAR") :
    null
    ), /*#__PURE__*/
    ...
    msgs.map((m, i) => {
      if (m.role === "tool") {
        return (/*#__PURE__*/
          React.createElement("div", { key: i, className: `cxo2-toolchip ${m.failed ? "is-failed" : ""}`, title: m.content }, /*#__PURE__*/
          React.createElement("b", null, "\u2692 ", m.tool), /*#__PURE__*/
      ...
      return (/*#__PURE__*/
        ...
        m.content.split(/\n{2,}/).map((p, j) => /*#__PURE__*/React.createElement("p", { key: j }, p))
        )
