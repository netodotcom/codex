// GENERATED from mobile.jsx by scripts/build-jsx.mjs — do not edit; edit the .jsx and run `npm run build`.
(function () {
...
function MobileTrace({ dark, onToggleTheme }) {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "cx-mtrace", role: "toolbar", "aria-label": "System" }, /*#__PURE__*/
    React.createElement("span", { className: "cx-mtrace-time" }, hh, ":", mm), /*#__PURE__*/
...
function MobileOrb({ busy, streak, pos, onPos, onTap, onLongPress, hidden }) {
  ...
  return (/*#__PURE__*/
    React.createElement("button", {
      ...
      title: "The palm \u2014 every tool (hold: focus)" }, /*#__PURE__*/

    React.createElement("svg", { className: "cx-orb-ring", viewBox: "0 0 56 56", "aria-hidden": "true" }, /*#__PURE__*/
    React.createElement("circle", { cx: "28", cy: "28", r: "24", className: "cx-orb-track" }),
    arc > 0 ? /*#__PURE__*/
    React.createElement("circle", { cx: "28", cy: "28", r: "24", className: "cx-orb-streak",
      strokeDasharray: `${arc} ${Math.max(0, 151 - arc)}`,
      transform: "rotate(-90 28 28)" }) :
    null
    ), /*#__PURE__*/
    React.createElement("span", { className: "cx-orb-core", "aria-hidden": "true" }, "\u2726")
    ));
...
function MobileSheet({ sheet, isTop, canBack, onClose, onBack, children }) {
  ...
  return (/*#__PURE__*/
    React.createElement("section", {
      ...
      "data-sheet": sheet.key }, /*#__PURE__*/

    React.createElement("header", { className: "cx-sheet-h", ref: headRef }, /*#__PURE__*/
    React.createElement("span", { className: "cx-sheet-grab", "aria-hidden": "true" }), /*#__PURE__*/
    React.createElement("div", { className: "cx-sheet-row" }, /*#__PURE__*/
    React.createElement("button", { className: "cx-sheet-back", onClick: canBack ? onBack : onClose,
      "aria-label": canBack ? "Back" : "Close", title: canBack ? "Back" : "Close" }, "\u2039"), /*#__PURE__*/
    React.createElement("span", { className: "cx-sheet-glyph", "aria-hidden": "true" }, sheet.glyph), /*#__PURE__*/
    React.createElement("b", { className: "cx-sheet-title" }, sheet.title), /*#__PURE__*/
    React.createElement("button", { className: "cx-sheet-x", onClick: onClose, "aria-label": `Close ${sheet.title}`, title: "Close" }, "\xD7")
    )
    ), /*#__PURE__*/
    React.createElement("div", { className: "cx-sheet-body" }, children)
    ));
...
function MobilePluginBody({ panelId }) {
  ...
  if (!panel || !Host) {
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-sheet-missing" }, /*#__PURE__*/
      React.createElement("b", null, "PANEL UNAVAILABLE"), /*#__PURE__*/
      React.createElement("p", null, panel ? "host not loaded" : "this panel hasn't registered yet")
      ));
...
function MobilePalm({ onClose, onOpenSheet, builtinWin }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", { className: "cx-palm-scrim", onClick: onClose, "aria-hidden": "true" }), /*#__PURE__*/
    React.createElement("section", { className: "cx-palm", role: "dialog", "aria-modal": "true", "aria-label": "The palm", ref: ref }, /*#__PURE__*/
    React.createElement("header", { className: "cx-palm-head", ref: headRef }, /*#__PURE__*/
    React.createElement("span", { className: "cx-sheet-grab", "aria-hidden": "true" }),
    ref0 ? /*#__PURE__*/React.createElement("span", { className: "cx-palm-now" }, ref0) : /*#__PURE__*/React.createElement("span", { className: "cx-palm-now is-dim" }, "THE PALM")
    ), /*#__PURE__*/

    React.createElement("div", { className: "cx-palm-grip", role: "group", "aria-label": "Launchers" },
    MOB_GRIP.map((g) => /*#__PURE__*/
    React.createElement("button", { key: g.id, className: "cx-palm-launch", onClick: () => {
        onClose();
        if (g.open) onOpenSheet(g.open);else
        if (g.run) g.run();
      }, "aria-label": g.label, title: g.label }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, g.glyph), /*#__PURE__*/React.createElement("span", null, g.label)
    )
    ),
    hot ? /*#__PURE__*/
    React.createElement("button", { className: "cx-palm-launch is-hot", onClick: () => openPanel(hot.id),
      "aria-label": `${hot.label} — your most-used panel`, title: `${hot.label} — your most-used panel` }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, hot.glyph), /*#__PURE__*/React.createElement("span", null, hot.label)
    ) :
    null
    ), /*#__PURE__*/

    React.createElement("div", { className: "cx-palm-verbs", role: "group", "aria-label": "Verse actions" },
    MOB_VERBS.map((v) => /*#__PURE__*/
    React.createElement("button", { key: v.kind, className: "cx-palm-verb", disabled: !ref0,
      onClick: () => verb(v.kind),
      title: ref0 ? `${v.label} — ${ref0}` : `${v.label} — open a verse first` }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, v.glyph), /*#__PURE__*/React.createElement("span", null, v.label)
    )
    ),
    trail ? /*#__PURE__*/
    React.createElement("button", { className: "cx-palm-verb is-continue", onClick: () => {
        onClose();
        if (window.codexJumpToRef) {try {window.codexJumpToRef(trail);} catch {}}
      }, title: `Continue — ${trail}` }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, "\u27F3"), /*#__PURE__*/React.createElement("span", null, "CONTINUE")
    ) :
    null
    ), /*#__PURE__*/

    React.createElement("div", { className: "cx-palm-panels", role: "group", "aria-label": "Panels" },
    builtinIds.map((id) => /*#__PURE__*/
    React.createElement("button", { key: id, className: "cx-palm-chip", onClick: () => openPanel(id), title: builtinWin[id].title }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, builtinWin[id].glyph), /*#__PURE__*/React.createElement("span", null, builtinWin[id].title)
    )
    ),
    pluginPanels.map((p) => /*#__PURE__*/
    React.createElement("button", { key: p.id, className: "cx-palm-chip is-plugin", onClick: () => openPanel(p.id), title: p.label }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, p.glyph), /*#__PURE__*/React.createElement("span", null, p.label)
    )
    ), /*#__PURE__*/
    React.createElement("button", { className: "cx-palm-chip is-sys", "data-tweaks-trigger": true,
      onClick: () => {onClose();try {window.postMessage({ type: "__activate_edit_mode" }, "*");} catch {}},
      title: "Settings" }, /*#__PURE__*/
    React.createElement("i", { "aria-hidden": "true" }, "\u2699"), /*#__PURE__*/React.createElement("span", null, "SETTINGS")
    )
    )
    )
    ));
...
function CodexMobileShell({ builtinWin, builtinBody, busy, dark, onToggleTheme }) {
  ...
  const bodyFor = (s) => {
    ...
    if (s.kind === "plugin") return /*#__PURE__*/React.createElement(MobilePluginBody, { panelId: s.id });
    return null;
  };

  return (/*#__PURE__*/
    React.createElement("div", { className: `cx-mob ${focus ? "is-focus" : ""}` }, /*#__PURE__*/
    React.createElement("div", { className: "cx-mob-reader", ref: readerWrapRef },
    window.CodexReaderX ?
    ...
    !focus ? /*#__PURE__*/React.createElement(MobileTrace, { dark: dark, onToggleTheme: onToggleTheme }) : null,

    sheets.map((s, i) => /*#__PURE__*/
    ...
    palm ? /*#__PURE__*/
    React.createElement(MobilePalm, {
