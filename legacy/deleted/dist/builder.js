// GENERATED from builder.jsx by scripts/build-jsx.mjs — do not edit; edit the .jsx and run `npm run build`.
(function () {
// builder.jsx
...
(function () {
  ...
  function BuilderPanel(ctx) {
    ...
    useEffect(() => {
      ...
      const drop = async (e) => {
        ...
        try {
          ...
          if (importStudyObject(obj)) setStore(loadStore());else
    ...
    // ── Render ──
    return (/*#__PURE__*/
      React.createElement("div", { className: "cx-builder" }, /*#__PURE__*/
      React.createElement("header", { className: "cx-builder-hdr" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-titlerow" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-glyph" }, "\u2761"), /*#__PURE__*/
      React.createElement("b", null, "STUDIES"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: newStudy, title: "New study" }, "+ New"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: () => fileInputRef.current && fileInputRef.current.click(), title: "Import a .codex-study file" }, "\u21E1 Import"), /*#__PURE__*/
      ...
      React.createElement("div", { className: "cx-builder-studylist" },
      store.studies.length === 0 ? /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-empty" }, "No studies yet. Tap ", /*#__PURE__*/React.createElement("b", null, "+ New"), " to start.") :

      store.studies.map((s) => /*#__PURE__*/
      React.createElement("div", { key: s.id, className: `cx-builder-studyrow ${s.id === store.activeStudyId ? "is-active" : ""}` }, /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-studybtn", onClick: () => switchTo(s.id), title: `Switched to ${s.title}` }, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-studytitle" }, s.title), /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-studymeta" },
      s.sections.length, " sec \xB7 ", s.sections.reduce((n, x) => n + x.items.length, 0), " items"
      )
      ), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-del", onClick: () => deleteStudy(s.id), title: "Delete study" }, "\xD7")
      )
      )
      ...
      React.createElement("div", { className: "cx-builder-active", ref: dropZoneRef },
      !active ? /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-empty" }, "Drop a ", /*#__PURE__*/
      React.createElement("code", null, ".codex-study"), " file here, or create a new study above."
      ) : /*#__PURE__*/
      ...
      active.sections.map((sec) => /*#__PURE__*/
      React.createElement("section", {
        ...
        onDrop: onSectionDrop(sec.id) }, /*#__PURE__*/

      React.createElement("div", { className: "cx-builder-sechead" }, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-grip", title: "Drag to reorder section" }, "\u22EE\u22EE"), /*#__PURE__*/
      React.createElement("input", {
      ...
      React.createElement("button", { className: "cx-builder-del", onClick: () => removeSection(sec.id), title: "Remove section" }, "\xD7")
      ), /*#__PURE__*/

      React.createElement("ul", { className: "cx-builder-items" },
      sec.items.length === 0 ? /*#__PURE__*/
      React.createElement("li", { className: "cx-builder-empty cx-builder-itemempty",
        onDragOver: allowDrop, onDrop: onItemDrop(sec.id, 0) }, "Empty \u2014 drop items here, or use the buttons below."

      ) :
      sec.items.map((it, idx) => /*#__PURE__*/
      React.createElement("li", {
        ...
        onDragOver: allowDrop,
        onDrop: onItemDrop(sec.id, idx) }, /*#__PURE__*/

      React.createElement("span", { className: "cx-builder-grip", title: "Drag to reorder" }, "\u22EE\u22EE"), /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-itembody" },
      it.type === "verse" && /*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-refbadge" }, formatRef(it.ref)),
      it.translation ? /*#__PURE__*/React.createElement("span", { className: "cx-builder-trbadge" }, String(it.translation).toUpperCase()) : null, /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-verse-text" }, it.text || /*#__PURE__*/React.createElement("em", null, "(no text)"))
      ),

      it.type === "note" && /*#__PURE__*/
      ...
      it.type === "panel" && /*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-kindbadge" }, it.kind || "Panel"),
      it.source ? /*#__PURE__*/React.createElement("span", { className: "cx-builder-srcbadge" }, formatRef(it.source)) : null, /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-panel-text" }, it.body)
      ),

      it.type === "crossref" && /*#__PURE__*/
      React.createElement(React.Fragment, null, /*#__PURE__*/
      React.createElement("span", { className: "cx-builder-refbadge" }, "\u2197 ", formatRef(it.ref)), /*#__PURE__*/
      React.createElement("input", {
      ...
      React.createElement("button", { className: "cx-builder-del", onClick: () => removeItem(sec.id, idx), title: "Remove item" }, "\xD7")
      )
      )
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-builder-sectools" }, /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: () => addNote(sec.id) }, "+ Note"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: () => addVerseFromContext(sec.id), title: "Add the current verse from the reader" }, "+ Verse from current")
      )
      )
      ), /*#__PURE__*/

      React.createElement("div", { className: "cx-builder-addsec" }, /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: addSection }, "+ Section")
      ), /*#__PURE__*/

      React.createElement("footer", { className: "cx-builder-foot" }, /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-exportrow" }, /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: exportMd, title: "Download Markdown" }, "\u21E3 Markdown"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: exportPdf, title: "Print to PDF" }, "\u21E3 PDF"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: copyMd, title: "Copy as Markdown" }, "\u29C9 Copy"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: share, title: "Share URL" }, "\u2197 Share"), /*#__PURE__*/
      React.createElement("button", { className: "cx-builder-btn", onClick: exportJson, title: "Export .codex-study" }, "\u21E3 .codex-study")
      ), /*#__PURE__*/
      React.createElement("div", { className: "cx-builder-hint" }, "Add verses via the verse menu\u2019s ", /*#__PURE__*/
      React.createElement("b", null, "Add to Study"), ", or drop a ", /*#__PURE__*/React.createElement("code", null, ".codex-study"), " file onto this panel to import."
      )
      )
      )
  ...
  function syncPrintable() {
    ...
    for (const ln of lines) {
      if (/^# /.test(ln)) {if (inList) {out.push("</ul>");inList = false;}if (inQuote) {out.push("</blockquote>");inQuote = false;}out.push(`<h1>${escapeHtml(ln.slice(2))}</h1>`);} else
      if (/^## /.test(ln)) {if (inList) {out.push("</ul>");inList = false;}if (inQuote) {out.push("</blockquote>");inQuote = false;}out.push(`<h2>${escapeHtml(ln.slice(3))}</h2>`);} else
      if (/^> /.test(ln)) {if (inList) {out.push("</ul>");inList = false;}if (!inQuote) {out.push("<blockquote>");inQuote = true;}out.push(`<div>${mdInline(ln.slice(2))}</div>`);} else
      if (/^- /.test(ln)) {if (inQuote) {out.push("</blockquote>");inQuote = false;}if (!inList) {out.push("<ul>");inList = true;}out.push(`<li>${mdInline(ln.slice(2))}</li>`);} else
      if (ln.trim() === "") {if (inList) {out.push("</ul>");inList = false;}if (inQuote) {out.push("</blockquote>");inQuote = false;}out.push("");} else
      {if (inList) {out.push("</ul>");inList = false;}if (inQuote) {out.push("</blockquote>");inQuote = false;}out.push(`<p>${mdInline(ln)}</p>`);}
    }
